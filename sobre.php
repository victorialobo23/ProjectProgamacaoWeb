...
<body>
            ...
            <div class="row">
                <div class="col-md-6 text-center text-lg-left mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-white pr-3" href="">Peguntas</a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-lg-4 py-5">
                    ...
                    <h5 class="text-muted mb-3">Somos a maior casa de gelados de Luanda, e as nossas misturas são excepcional</h5>
                    <p> A felicidade tem muitos sabores, Frescos, Cremosos, Deliciosos e Tradicional</p>
                ...
                <div class="col-lg-4 py-5">
                    <h4 class="font-weight-bold mb-3">Nossas Caracteristicas</h4>
                    <p>Somos uma Empresa justa. Seria e Comrpometida com o que fazemos. </p>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-6">
                    <h1 class="section-title position-relative mb-5">Experimente os melhores e mais  Famosos Gelados</h1>
                </div>
                        ...
                        <div class="team-item">
                            ...
                            <div class="position-relative text-center bg-light rounded px-4 py-5" style="margin-top: -100px;">
                                ...
                                <div class="d-flex justify-content-center pt-1">
                                    ...
                                    <a class="btn btn-outline-secondary btn-social mr-2" href="#"><i class="fab fa-instagran"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="team-item">
                            ...
                            <div class="position-relative text-center bg-light rounded px-4 py-5" style="margin-top: -100px;">
                                ...
                                <div class="d-flex justify-content-center pt-1">
                                    <a class="btn btn-outline-secondary btn-social mr-2" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-secondary btn-social mr-2" href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-secondary btn-social mr-2" href="#"><i class="fab fa-intagram"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="team-item">
                ...
                <div class="col-12 mt-2 mb-4">
                    <div class="row">
                        <div class="col-sm-6 text-center text-sm-right border-right mb-3 mb-sm-0">
                            <h5 class="font-weight-bold mb-2">Entra em Contacto</h5>
                            <p class="mb-2">Rua 5, Maianga, Luanda</p>
                            <p class="mb-0">+244995185125</p>
                        </div>
                        <div class="col-sm-6 text-center text-sm-left">
                            <h5 class="font-weight-bold mb-2">Horario de Trabalho</h5>
